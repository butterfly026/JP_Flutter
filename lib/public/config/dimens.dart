// ignore_for_file: avoid_classes_with_only_static_members, noop_primitive_operations, non_constant_identifier_names
...
class Dimens {
  ...
  static double get font_sp8 => ScreenUtil().setSp(8.0).toDouble();
  ...
  static double get font_sp22 => ScreenUtil().setSp(22.0).toDouble();
  ...
  static double get gap_dp34 => ScreenUtil().setWidth(34.0).toDouble();

  static double get gap_dp36 => ScreenUtil().setWidth(36.0).toDouble();

  static double get gap_dp38 => ScreenUtil().setWidth(38.0).toDouble();

  static double get gap_dp40 => ScreenUtil().setWidth(40.0).toDouble();

  static double get gap_dp42 => ScreenUtil().setWidth(42.0).toDouble();
  ...
  static double get gap_dp62 => ScreenUtil().setWidth(62.0).toDouble();

  static double get gap_dp64 => ScreenUtil().setWidth(64.0).toDouble();

  static double get gap_dp66 => ScreenUtil().setWidth(66.0).toDouble();

  static double get gap_dp70 => ScreenUtil().setWidth(70.0).toDouble();

  static double get gap_dp80 => ScreenUtil().setWidth(80.0).toDouble();

  static double get gap_dp82 => ScreenUtil().setWidth(82.0).toDouble();

  static double get gap_dp88 => ScreenUtil().setWidth(88.0).toDouble();

  static double get gap_dp92 => ScreenUtil().setWidth(92.0).toDouble();

  static double get gap_dp96 => ScreenUtil().setWidth(96.0).toDouble();

  static double get gap_dp100 => ScreenUtil().setWidth(100.0).toDouble();

  static double get gap_dp150 => ScreenUtil().setWidth(150.0).toDouble();

  static double get gap_dp200 => ScreenUtil().setWidth(200.0).toDouble();

  static double get gap_dp300 => ScreenUtil().setWidth(300.0).toDouble();
}
