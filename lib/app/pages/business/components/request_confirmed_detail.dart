              ...
              children: [
                      ...
                      Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                TextSubitleValue(title: '■依頼内容詳細', value: ''),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      TextInfoTitle(
                          title: '【依頼者情報】', type: RequestInfo.SECTION_TITLE),
                      Padding(
                          padding: EdgeInsets.all(Dimens.gap_dp10),
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      TextInfoTitle(
                          title: '【緊急時連絡先】', type: RequestInfo.SECTION_TITLE),
                      Padding(
                          padding: EdgeInsets.all(Dimens.gap_dp10),
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Padding(
                                    padding:
                                        EdgeInsets.only(left: Dimens.gap_dp20),
                                    child: Align(
                                        alignment: Alignment.topLeft,
                                        child: Text('運営',
                                            style: AppTheme.subtitle))),
                                TextSubitleValue(title: '■担当者', value: '秋田太郎'),
                                TextSubitleValue(
                                  title: '■連絡先',
                                  value: '080-1111-2222',
                                ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      TextInfoTitle(
                          title: '【過去の依頼内容】', type: RequestInfo.SECTION_TITLE),
                      Padding(
                          padding: EdgeInsets.all(Dimens.gap_dp10),
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
